...
Practice speaking german with cards without a partner`;
export const Register = 'Register';
export const Login = 'Login';
export const HEADER_LOGIN = "Let's sign you in";
export const BODY_LOGIN = `Welcome back.
You have been missed!`;
export const HEADER_REG = "Let's prepare you in";
